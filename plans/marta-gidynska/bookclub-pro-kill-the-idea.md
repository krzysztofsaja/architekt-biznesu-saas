...
Plan - MVP może zostać rozbudowany w stronę proponowanych pivotów (nawet kilku z nich) za pomocą dodatkowych funkcjonalności, więc sam szkielet projektu ma potencjał (a przynajmniej największy potencjał spośród dotychczas analizowanych opcji)
