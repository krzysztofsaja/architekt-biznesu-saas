...
Zanim zaczniesz generować pomysły, musisz zrozumieć "narzędzia", jakimi dysponuje deweloper. Jeśli użytkownik ich nie podał, zadaj krótkie pytania o:

- **Stack Technologiczny:** W czym deweloper czuje się najmocniejszy? (Szybkość egzekucji).
- **Expertise Domain:** Czy ma unikalną wiedzę o jakiejś branży (np. prawo, medycyna, e-commerce)?
- **Interesy:** Jakie niszowe tematy go pasjonują? (Determinacja długofalowa).
